...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_CAN1_REF_CTRL_DIVISOR0                          0x4

    * 000 = IOPLL; 010 = RPLL; 011 = DPLL; (This signal may only be toggled af
    * ter 4 cycles of the old clock and 4 cycles of the new clock. This is not
    *  usually an issue, but designers must be aware.)
    *  PSU_CRL_APB_CAN1_REF_CTRL_SRCSEL                            0x3

    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0088, 0x013F3F07U ,0x01010403U)
    */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDRC_DRAMTMG0_OFFSET, 0x7F3F7F3FU, 0x11122814U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDRC_DRAMTMG1_OFFSET, 0x001F1F7FU, 0x0004041DU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_DTPR0_OFFSET, 0xFFFFFFFFU, 0x08281009U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_DTPR5_OFFSET, 0xFFFFFFFFU, 0x00391009U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180320, 0x00003384U ,0x00000284U)
    */
	PSU_Mask_Write(IOU_SLCR_SD_CONFIG_REG2_OFFSET,
		0x00003384U, 0x00000284U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(SERDES_PLL_REF_SEL2_OFFSET, 0x0000001FU, 0x00000009U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * SERDES ILL CALIB
    */
		serdes_illcalib(4,0,4,0,0,0,5,0);
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(SERDES_ICM_CFG0_OFFSET, 0x00000007U, 0x00000005U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(SERDES_ICM_CFG1_OFFSET, 0x00000077U, 0x00000044U);
/*##################################################################### */
    ...
    */
    /*
    * Register : L2_TXPMD_TM_45 @ 0XFD408CB4
    ...
    */
	PSU_Mask_Write(SERDES_L2_TXPMD_TM_45_OFFSET,
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(SERDES_L3_TXPMD_TM_45_OFFSET,
		0x00000037U, 0x00000037U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
    /*
    * Register : L2_TXPMD_TM_48 @ 0XFD408CC0
    ...
    */
	PSU_Mask_Write(SERDES_L2_TXPMD_TM_48_OFFSET,
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(SERDES_L3_TXPMD_TM_48_OFFSET,
		0x0000001FU, 0x00000000U);
/*##################################################################### */
