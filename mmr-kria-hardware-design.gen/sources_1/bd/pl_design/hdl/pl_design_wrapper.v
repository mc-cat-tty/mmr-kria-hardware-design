...
module pl_design_wrapper
   (fan,
    led_uf1_tri_io);
  output [0:0]fan;
  inout [1:0]led_uf1_tri_io;

  wire [0:0]fan;
  wire [0:0]led_uf1_tri_i_0;
  wire [1:1]led_uf1_tri_i_1;
  wire [0:0]led_uf1_tri_io_0;
  wire [1:1]led_uf1_tri_io_1;
  wire [0:0]led_uf1_tri_o_0;
  wire [1:1]led_uf1_tri_o_1;
  wire [0:0]led_uf1_tri_t_0;
  wire [1:1]led_uf1_tri_t_1;
  ...
  pl_design pl_design_i
       (.fan(fan),
        .led_uf1_tri_i({led_uf1_tri_i_1,led_uf1_tri_i_0}),
        .led_uf1_tri_o({led_uf1_tri_o_1,led_uf1_tri_o_0}),
        .led_uf1_tri_t({led_uf1_tri_t_1,led_uf1_tri_t_0}));
endmodule
